...
import org.spout.vanilla.protocol.codec.AnimateEntityCodec;
...
public class VanillaCodecLookupService extends CodecLookupService {
	public VanillaCodecLookupService() {
		try {
			...
			/* 0x23 */bind(EntityHeadYawCodec.class);
			...
			/* 0x36 */bind(BlockActionCodec.class);
			...
			/* 0x84 */bind(TileEntityDataCodec.class);
