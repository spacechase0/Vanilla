...
public final class VanillaMaterials {
	...
	public static final BlockMaterial GRASS = new Grass("Grass").setHardness(0.6F);
	public static final BlockMaterial DIRT = new Solid("Dirt", 3).setHardness(0.5F);
	...
	public static final BlockMaterial SAPLING = new Sapling("Sapling", 0).setHardness(0.0F);
	public static final BlockMaterial SPRUCE_SAPLING = new Sapling("Spruce Sapling", 1).setHardness(0.0F);
	public static final BlockMaterial BIRCH_SAPLING = new Sapling("Birch Sapling", 2).setHardness(0.0F);
	public static final BlockMaterial BEDROCK = new Solid("Bedrock", 7).setResistance(6000000.0F);
	public static final BlockMaterial WATER = new GenericLiquid("Water", 8, true).setHardness(100.0F);
	public static final BlockMaterial STATIONARY_WATER = new GenericLiquid("Stationary Water", 9, false).setHardness(100.0F);
	public static final BlockMaterial LAVA = new GenericLiquid("Lava", 10, true).setHardness(0.0F).setLightLevel(1);
	public static final BlockMaterial STATIONARY_LAVA = new GenericLiquid("Stationary Lava", 11, false).setHardness(100.0F).setLightLevel(1);
	public static final BlockMaterial SAND = new Solid("Sand", 12, true).setHardness(0.5F);
	public static final BlockMaterial GRAVEL = new Solid("Gravel", 13, true).setHardness(0.6F);
	public static final BlockMaterial GOLD_ORE = new Solid("Gold Ore", 14).setHardness(3.0F);
	public static final BlockMaterial IRON_ORE = new Solid("Iron Ore", 15).setHardness(3.0F);
	public static final BlockMaterial COAL_ORE = new Solid("Coal Ore", 16).setHardness(3.0F);
	public static final BlockMaterial LOG = new Tree("Wood", 17, 0).setHardness(2.0F);
	public static final BlockMaterial SPRUCE_LOG = new Tree("Wood", 17, 1).setHardness(0.2F);
	public static final BlockMaterial BIRCH_LOG = new Tree("Wood", 17, 2).setHardness(0.2F);
	public static final BlockMaterial LEAVES = new Tree("Leaves", 18, 0).setHardness(0.2F);
	public static final BlockMaterial SPRUCE_LEAVES = new Tree("Leaves", 18, 1).setHardness(0.2F);
	public static final BlockMaterial BIRCH_LEAVES = new Tree("Leaves", 18, 2).setHardness(0.2F);
	public static final BlockMaterial SPONGE = new Solid("Sponge", 19).setHardness(0.6F);
	public static final BlockMaterial GLASS = new Solid("Glass", 20).setHardness(0.3F);
	...
	public static final BlockMaterial DISPENSER = new Solid("Dispenser", 23).setHardness(3.5F);
	public static final BlockMaterial SANDSTONE = new Solid("Sandstone", 24).setHardness(0.8F);
	public static final BlockMaterial NOTEBLOCK = new Solid("Note Block", 25).setHardness(0.8F);
	public static final BlockMaterial BED_BLOCK = new Solid("Bed", 26).setHardness(0.2F);
	public static final BlockMaterial POWERED_RAIL = new Solid("Powered Rail", 27).setHardness(0.7F);
	public static final BlockMaterial DETECTOR_RAIL = new Solid("Detector Rail", 28).setHardness(0.7F);
	public static final BlockMaterial PISTON_STICKY_BASE = new Solid("Sticky Piston", 29);
	public static final BlockMaterial WEB = new Solid("Cobweb", 30).setHardness(4.0F);
	...
	public static final BlockMaterial PISTON_BASE = new Solid("Piston", 33);
	public static final BlockMaterial PISTON_EXTENSION = new Solid("Piston (Head)", 34);
	public static final BlockMaterial WHITE_WOOL = new Wool("Wool", 35, 0).setHardness(0.8F);
	public static final BlockMaterial ORANGE_WOOL = new Wool("Orange Wool", 35, 1).setHardness(0.8F);
	public static final BlockMaterial MAGENTA_WOOL = new Wool("Magenta Wool", 35, 2).setHardness(0.8F);
	public static final BlockMaterial LIGHT_BLUE_WOOL = new Wool("Light Blue Wool", 35, 3).setHardness(0.8F);
	public static final BlockMaterial YELLOW_WOOL = new Wool("Yellow Wool", 35, 4).setHardness(0.8F);
	public static final BlockMaterial LIME_WOOL = new Wool("Light Green Wool", 35, 5).setHardness(0.8F);
	public static final BlockMaterial PINK_WOOL = new Wool("Pink Wool", 35, 6).setHardness(0.8F);
	public static final BlockMaterial GREY_WOOL = new Wool("Grey Wool", 35, 7).setHardness(0.8F);
	public static final BlockMaterial LIGHT_GREY_WOOL = new Wool("Light Grey Wool", 35, 8).setHardness(0.8F);
	public static final BlockMaterial CYAN_WOOL = new Wool("Cyan Wool", 35, 9).setHardness(0.8F);
	public static final BlockMaterial PURPLE_WOOL = new Wool("Purple Wool", 35, 10).setHardness(0.8F);
	public static final BlockMaterial BLUE_WOOL = new Wool("Blue Wool", 35, 11).setHardness(0.8F);
	public static final BlockMaterial BROWN_WOOL = new Wool("Brown Wool", 35, 12).setHardness(0.8F);
	public static final BlockMaterial GREEN_WOOL = new Wool("Dark Green Wool", 35, 13).setHardness(0.8F);
	public static final BlockMaterial RED_WOOL = new Wool("Red Wool", 35, 14).setHardness(0.8F);
	public static final BlockMaterial BLACK_WOOL = new Wool("Black Wool", 35, 15).setHardness(0.8F);
	public static final BlockMaterial MOVED_BY_PISTON = new Solid("Moved By Piston", 36);
	public static final BlockMaterial DANDELION = new GroundAttachable("Dandelion", 37).setHardness(0.0F);
	public static final BlockMaterial ROSE = new GroundAttachable("Rose", 38).setHardness(0.0F);
	public static final BlockMaterial BROWN_MUSHROOM = new GroundAttachable("Brown Mushroom", 39).setHardness(0.0F);
	public static final BlockMaterial RED_MUSHROOM = new GroundAttachable("Red Mushroom", 40).setHardness(0.0F);
	public static final BlockMaterial GOLD_BLOCK = new Solid("Gold Block", 41).setHardness(3.0F);
	public static final BlockMaterial IRON_BLOCK = new Solid("Iron Block", 42).setHardness(5.0F);
	...
	public static final BlockMaterial TNT = new Solid("TNT", 46).setHardness(0.0F);
	public static final BlockMaterial BOOKSHELF = new Solid("Bookshelf", 47).setHardness(1.5F);
	public static final BlockMaterial MOSS_STONE = new Solid("Moss Stone", 48).setHardness(2.0F).setResistance(10.0F);
	public static final BlockMaterial OBSIDIAN = new Solid("Obsidian", 49).setHardness(50.0F).setResistance(2000.0F);
	public static final BlockMaterial TORCH = new WallAttachable("Torch", 50).setHardness(0.0F);
	public static final BlockMaterial FIRE = new Solid("Fire", 51).setHardness(0.0F);
	public static final BlockMaterial MONSTER_SPAWNER = new Solid("Monster Spawner", 52).setHardness(5.0F);
	public static final BlockMaterial WOODEN_STAIRS = new Solid("Wooden Stairs", 53);
	public static final BlockMaterial CHEST = new Solid("Chest", 54).setHardness(2.5F);
	public static final BlockMaterial REDSTONE_WIRE = new RedstoneWire("Redstone Wire", 55, 0).setHardness(0.0F);
	...
	public static final BlockMaterial CRAFTING_TABLE = new Solid("Crafting Table", 58).setHardness(2.5F);
	public static final BlockMaterial CROPS = new Solid("Seeds", 59).setHardness(0.0F);
	public static final BlockMaterial FARMLAND = new Solid("Farmland", 60).setHardness(0.6F);
	public static final BlockMaterial FURNACE = new Solid("Furnace", 61).setHardness(3.5F);
	public static final BlockMaterial BURNINGFURNACE = new Solid("Burning Furnace", 62).setHardness(3.5F);
	public static final BlockMaterial SIGN_POST = new Solid("Sign Post", 63).setHardness(1.0F);
	public static final BlockMaterial WOODEN_DOOR_BLOCK = new Solid("Wooden Door", 64).setHardness(3.0F);
	public static final BlockMaterial LADDERS = new Solid("Ladders", 65).setHardness(0.4F);
	public static final BlockMaterial RAILS = new Solid("Rails", 66).setHardness(0.7F);
	public static final BlockMaterial COBBLESTONE_STAIRS = new Solid("Cobblestone Stairs", 67);
	public static final BlockMaterial WALL_SIGN = new Solid("Wall Sign", 68).setHardness(1.0F);
	public static final BlockMaterial LEVER = new Solid("Lever", 69).setHardness(0.5F);
	public static final BlockMaterial STONE_PRESSURE_PLATE = new Solid("Stone Pressure Plate", 70).setHardness(0.5F);
	public static final BlockMaterial IRON_DOOR_BLOCK = new Solid("Iron Door", 71).setHardness(5.0F);
	public static final BlockMaterial WOODEN_PRESSURE_PLATE = new Solid("Wooden Pressure Plate", 72).setHardness(0.5F);
	...
	public static final BlockMaterial REDSTONE_TORCH_OFF = new RedstoneTorch("Redstone Torch", 75, false).setHardness(0.0F);
	public static final BlockMaterial REDSTONE_TORCH_ON = new RedstoneTorch("Redstone Torch (On)", 76, true).setHardness(0.0F);
	public static final BlockMaterial STONE_BUTTON = new Solid("Stone Button", 77).setHardness(0.5F);
	public static final BlockMaterial SNOW = new Solid("Snow", 78).setHardness(0.1F);
	public static final BlockMaterial ICE = new Solid("Ice", 79).setHardness(0.5F);
	public static final BlockMaterial SNOW_BLOCK = new Solid("Snow Block", 80).setHardness(0.2F);
	public static final BlockMaterial CACTUS = new Cactus("Cactus", 81).setHardness(0.4F);
	public static final BlockMaterial CLAY_BLOCK = new Solid("Clay Block", 82).setHardness(0.6F);
	public static final BlockMaterial SUGAR_CANE_BLOCK = new Solid("Sugar Cane", 83).setHardness(0.0F);
	public static final BlockMaterial JUKEBOX = new Solid("Jukebox", 84).setHardness(2.0F);
	public static final BlockMaterial FENCE = new Solid("Fence", 85).setResistance(5.0F);
	public static final BlockMaterial PUMPKIN = new Solid("Pumpkin", 86).setHardness(1.0F);
	public static final BlockMaterial NETHERRACK = new Solid("Netherrack", 87).setHardness(0.4F);
	public static final BlockMaterial SOUL_SAND = new Solid("Soul Sand", 88).setHardness(0.5F);
	public static final BlockMaterial GLOWSTONE_BLOCK = new Solid("Glowstone Block", 89).setHardness(0.3F);
	public static final BlockMaterial PORTAL = new Solid("Portal", 90).setHardness(-1.0F);
	public static final BlockMaterial JACK_O_LANTERN = new Solid("Jack 'o' Lantern", 91).setHardness(1.0F);
	public static final BlockMaterial CAKE_BLOCK = new Solid("Cake Block", 92).setHardness(0.5F);
	public static final BlockMaterial REDSTONE_REPEATER_OFF = new Solid("Redstone Repeater", 93).setHardness(0.0F);
	public static final BlockMaterial REDSTONE_REPEATER_ON = new Solid("Redstone Repeater (On)", 94).setHardness(0.0F);
	public static final BlockMaterial LOCKED_CHEST = new Solid("Locked Chest", 95).setHardness(0.0F);
	public static final BlockMaterial TRAPDOOR = new Solid("Trapdoor", 96).setHardness(3.0F);
	public static final BlockMaterial SILVERFISH_STONE = new Solid("Silverfish Stone", 97).setHardness(0.75F);
	public static final BlockMaterial STONE_BRICKS = new StoneBrick("Stone Brick", 98, 0).setHardness(1.5F);
	public static final BlockMaterial MOSSY_STONE_BRICKS = new StoneBrick("Mossy Stone Brick", 98, 1).setHardness(1.5F);
	public static final BlockMaterial CRACKED_STONE_BRICKS = new StoneBrick("Cracked Stone Brick", 98, 2).setHardness(1.5F);
	public static final BlockMaterial HUGE_BROWN_MUSHROOM = new Solid("Huge Brown Mushroom", 99).setHardness(0.2F);
	public static final BlockMaterial HUGE_RED_MUSHROOM = new Solid("Huge Red Mushroom", 100).setHardness(0.2F);
	public static final BlockMaterial IRON_BARS = new Solid("Iron Bars", 101).setHardness(5.0F);
	public static final BlockMaterial GLASS_PANE = new Solid("Glass Pane", 102).setHardness(0.3F);
	public static final BlockMaterial WATERMELON = new Solid("Watermelon", 103).setHardness(1.0F);
	public static final BlockMaterial PUMPKIN_STEM = new Solid("Pumpkin Stem", 104).setHardness(0.0F);
	public static final BlockMaterial MELON_STEM = new Solid("Melon Stem", 105).setHardness(0.0F);
	public static final BlockMaterial VINES = new Solid("Vines", 106).setHardness(0.2F);
	public static final BlockMaterial FENCE_GATE = new Solid("Fence Gate", 107).setHardness(2.0F);
	public static final BlockMaterial BRICK_STAIRS = new Solid("Brick Stairs", 108);
	public static final BlockMaterial STONE_BRICK_STAIRS = new Solid("Stone Brick Stairs", 109);
	public static final BlockMaterial MYCELIUM = new Solid("Mycelium", 110).setHardness(0.6F);
	public static final BlockMaterial LILY_PAD = new Solid("Lily Pad", 111).setHardness(0.0F);
	...
	public static final BlockMaterial NETHER_BRICK_STAIRS = new Solid("Nether Brick Stairs", 114);
	public static final BlockMaterial NETHER_WART_BLOCK = new Solid("Nether Wart", 115);
	...
	public static final BlockMaterial BREWING_STAND_BLOCK = new Solid("Brewing Stand", 117).setHardness(0.5F);
	public static final BlockMaterial CAULDRON_BLOCK = new Solid("Cauldron", 118).setHardness(2.0F);
